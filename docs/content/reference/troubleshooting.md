...
Most of these come down to network reality or how edx serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

edx rate-limits like any public site. edx already paces
...
Where a surface is gated, edx reads a cookie or token you supply
...
`edx`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what edx actually did
